function Ant(crslId) {
	...
	if(id) {
		...
		this.crslRoot = document.querySelector('.sales__carousel')
	};

	// Carousel objects
	this.crslList = this.crslRoot.querySelector('.sales__additionals');
	this.crslElements = this.crslList.querySelectorAll('.sales__card-adittional');
	this.crslElemFirst = this.crslList.querySelector('.sales__card-adittional');
	this.leftArrow = this.crslRoot.querySelector('.sales-carousel-arrow-left');
	this.rightArrow = this.crslRoot.querySelector('.sales-carousel-arrow-right');
	this.indicatorDots = this.crslRoot.querySelector('.sales-carousel-dots');
